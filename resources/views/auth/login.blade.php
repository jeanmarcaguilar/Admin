...
<body class="min-h-screen bg-brand-primary relative overflow-hidden">
  ...
  <div class="min-h-screen flex relative z-10">
    ...
    <section class="hidden lg:flex w-1/2 items-center justify-center p-8 text-white">
      <div class="flex flex-col items-center justify-center w-full h-full max-w-lg">
        ...
        <!-- Illustration Area -->
        <div class="relative w-full h-64 my-6 overflow-hidden">
    ...
    <section class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-8">
      <div class="w-full max-w-sm glass-card rounded-2xl shadow-xl p-8">

  ...
  <div id="loadingScreen" class="fixed inset-0 z-[9999]">
    ...
    <div class="fixed inset-0 flex flex-col items-center justify-center p-4">
      ...
      <div class="text-center text-white">
        <h2 class="text-2xl font-bold mb-2">Loading Room & Equipment</h2>
        <p class="text-white/80 text-sm mb-4">Preparing room management system and loading equipment data...</p>

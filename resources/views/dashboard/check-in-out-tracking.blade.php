...
<body class="bg-brand-background-main min-h-screen">
    ...
    <div id="mainContent" class="opacity-0 transition-opacity duration-500">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                        <div class="flex flex-col md:flex-row md:items-center justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">Track and manage visitor check-ins and check-outs in
                                    real-time
                                </p>
                            </div>
                                    ...
                                    @forelse($__rows as $v)
                                        <tr class="table-row">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="ml-0">
                                                        ...
                                                        <div class="text-xs text-gray-500">{{ $v['company'] ?? '—' }}
                                                            @if(!empty($v['visitor_type'])) •
                                                                {{ ucfirst($v['visitor_type']) }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <button
                                                    class="view-btn text-brand-primary hover:text-brand-primary-hover mr-3"
                                                    data-id="{{ $v['id'] ?? '' }}" data-tooltip="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="text-red-600 hover:text-red-900 check-out-btn"
                                                    data-id="{{ $v['id'] ?? '' }}" data-tooltip="Check Out">
                                        ...
                                        @forelse(($allVisitors ?? []) as $v)
                                            <tr class="table-row">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <span
                                                        class="status-badge {{ $st === 'checked_in' ? 'status-in-progress' : ($st === 'checked_out' ? 'status-completed' : 'status-overdue') }}">{{ ucfirst($st) }}</span>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <button
                                                        class="view-btn text-brand-primary hover:text-brand-primary-hover mr-3"
                        ...
                        @if(count($__rows ?: $allVisitors ?? []) > 10)
                            <div class="bg-white px-6 py-3 flex items-center justify-between border-t border-gray-200">
                                ...
                                <div class="flex space-x-2">
                                    <button
                                        class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary">
                                        Previous
                                    </button>
                                    <button
                                        class="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary">
                                    ...
                                    @forelse(($recentCheckOuts ?? []) as $v)
                                        <tr class="table-row">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="text-xs text-gray-500">{{ $v['company'] ?? '—' }}
                                                    @if(!empty($v['visitor_type'])) • {{ ucfirst($v['visitor_type']) }}
                                                    @endif
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div id="viewVisitorModal" class="modal hidden" aria-modal="true" role="dialog"
            aria-labelledby="view-visitor-title">
            <div class="bg-white rounded-lg shadow-lg w-[480px] max-w-full mx-4 fade-in" role="document">
                <div class="flex justify-between items-center border-b border-gray-200 px-6 py-4">
                    ...
                    <button id="closeViewVisitorModal" type="button"
                ...
                <div class="px-6 pt-5 pb-6">
                    ...
                    <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                        <button id="closeViewVisitorModalFooter" type="button"
                            class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Close</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="checkOutModal" class="modal hidden" aria-modal="true" role="dialog" aria-labelledby="check-out-title">
            <div class="bg-white rounded-lg shadow-lg w-[360px] max-w-full mx-4 fade-in" role="document">
                <div class="flex justify-between items-center border-b border-gray-200 px-6 py-4">
                    ...
                    <button id="closeCheckOutModal" type="button"
                        class="text-gray-400 hover:text-gray-600 rounded-lg p-2 hover:bg-gray-100 transition-all duration-200"
                        aria-label="Close">
                        <i class="fas fa-times"></i>
                    </button>
                ...
                <div class="px-6 pt-5 pb-6">
                    ...
                    <div class="flex justify-end space-x-3 mt-5">
                        <button id="cancelCheckOut" type="button"
                        ...
                        <button id="confirmCheckOut" type="button"
                            class="px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors">Check
                            Out</button>
                    </div>
                </div>
            </div>
                ...
                <div class="px-6 pt-5 pb-6">
                    <form id="newCheckInForm" class="space-y-4">
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                <label for="newVisitorName" class="block text-sm font-medium text-gray-700 mb-1">Visitor
                                    Name *</label>
                                <input type="text" id="newVisitorName" name="visitorName"
                            ...
                            <div>
                                <label for="newHostName" class="block text-sm font-medium text-gray-700 mb-1">Host
                                    *</label>
                                <select id="newHostName" name="hostName"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent"
                                    required>
                            ...
                            <div>
                                <label for="newCheckInTime"
                                    class="block text-sm font-medium text-gray-700 mb-1">Check-In
                                    Time *</label>
                                <input type="time" id="newCheckInTime" name="checkInTime"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent"
                                    required>
                            </div>
                        </div>

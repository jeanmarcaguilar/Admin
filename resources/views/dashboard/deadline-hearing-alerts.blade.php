...
<body>
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-md border border-gray-100 p-8 space-y-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button id="addAlertBtn" class="px-4 py-2 bg-[#2f855A] text-white rounded-lg hover:bg-[#28644c] flex items-center text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#2f855A]">
    ...
    <!-- Add Alert Modal (moved outside main content) -->

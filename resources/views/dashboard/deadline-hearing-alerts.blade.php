        ...
        <div class="px-4 py-4 overflow-y-auto h-[calc(100%-4rem)] custom-scrollbar">
            ...
            <div id="legal-submenu" class="submenu mt-1">
                <div class="pl-4 pr-2 py-2 space-y-1 border-l-2 border-gray-100 ml-6">
                    ...
                    <a href="{{ route('deadline.hearing.alerts') }}" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 bg-green-50 text-brand-primary font-medium transition-all duration-200 hover:translate-x-1">
    ...
    <div class="md:pl-72">
        ...
        <header class="h-16 bg-white flex items-center justify-between px-4 sm:px-6 relative
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-lg font-bold text-gray-800 hidden md:block">Deadline & Hearing Alerts</h1>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Track and manage all legal deadlines, court hearings, and compliance dates</p>
                        </div>
                        <div class="mt-4 md:mt-0 flex space-x-3">
                            ...
                            <button id="addAlertBtn" class="px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-brand-primary-hover transition-colors font-medium flex items-center">
                ...
                <div class="mb-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div class="relative flex-1 max-w-md">
                            ...
                            <input type="text" id="searchInput" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-primary focus:border-brand-primary block w-full pl-10 p-2.5" placeholder="Search alerts...">
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Manage and track all your legal deadlines and hearings</p>
                        </div>
                        <button class="text-sm text-brand-primary hover:text-brand-primary-hover font-medium">View Calendar</button>
                    </div>
    ...
    <div id="addAlertModal" class="modal hidden" aria-modal="true" role="dialog" aria-labelledby="add-alert-modal-title">
        <div class="bg-white rounded-lg shadow-lg w-[360px] max-w-full mx-4 fade-in" role="document">
            <div class="flex justify-between items-center border-b border-gray-200 px-4 py-3">
                ...
                <button id="closeAddAlertModal" type="button" class="text-gray-400 hover:text-gray-600 rounded-lg p-2 hover:bg-gray-100 transition-all duration-200" aria-label="Close">
            ...
            <div class="px-6 pt-5 pb-6">
                <form id="addAlertForm" class="space-y-4 text-xs text-gray-700">
                    <div>
                        ...
                        <input type="text" id="alertTitle" name="alertTitle" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                    </div>
                    <div>
                        <label for="alertType" class="block text-xs font-medium text-gray-700 mb-1">Type *</label>
                        <select id="alertType" name="alertType" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                    ...
                    <div>
                        ...
                        <input type="date" id="dueDate" name="dueDate" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                    </div>
                    <div>
                        <label for="priority" class="block text-xs font-medium text-gray-700 mb-1">Priority *</label>
                        <select id="priority" name="priority" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent"></textarea>
                    </div>
                    <div>
                        <label for="relatedTo" class="block text-xs font-medium text-gray-700 mb-1">Related To (Optional)</label>
                        <input type="text" id="relatedTo" name="relatedTo" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" placeholder="Case #, Contract #, etc.">
                    </div>
                    <div class="flex justify-end space-x-3 pt-2">
                        <button type="button" id="cancelAddAlert" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Cancel</button>
                        <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-brand-primary hover:bg-brand-primary-hover rounded-lg transition-colors">Save Alert</button>
                    </div>
                </form>
            </div>
        </div>

...
<body class="bg-brand-background-main min-h-screen">
        ...
        <div class="px-4 py-4 overflow-y-auto h-[calc(100%-4rem)] custom-scrollbar">
            ...
            <div id="legal-submenu" class="submenu mt-1">
                <div class="pl-4 pr-2 py-2 space-y-1 border-l-2 border-gray-100 ml-6">
                    ...
                    <a href="{{ route('contract.management') }}" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 bg-green-50 text-brand-primary font-medium transition-all duration-200 hover:translate-x-1">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between">
                        ...
                        <div class="mt-4 md:mt-0">
                            <button id="addContractBtn" class="px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-brand-primary-hover transition-colors font-medium flex items-center">
                ...
                <div class="mb-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div class="relative flex-1 max-w-md">
                            ...
                            <input type="text" id="searchInput" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-primary focus:border-brand-primary block w-full pl-10 p-2.5" placeholder="Search contracts...">
                        </div>
                        <div class="flex space-x-3">
                            <select id="filterStatus" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-primary focus:border-brand-primary block w-full p-2.5">
                                <option value="">All Status</option>
                                <option value="active">Active</option>
                                <option value="pending">Pending</option>
                                <option value="expired">Expired</option>
                            </select>
                            <select id="filterType" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-primary focus:border-brand-primary block w-full p-2.5">
                            ...
                            <button class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium flex items-center">
                                ...
                                @forelse(($contracts ?? []) as $c)
                                    ...
                                    <tr class="contract-row" data-id="{{ $c->id }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $c->title ?? 'N/A' }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ ucfirst($c->type ?? 'N/A') }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button class="text-brand-primary hover:text-brand-primary-hover mr-3 viewContractBtn"
                                                    data-id="{{ $c->id }}" 
                                                    data-code="{{ $c->code }}" 
                                                    data-title="{{ $c->title }}"
                                                    data-type="{{ $c->type }}"
    ...
    <!-- Modals -->
    <!-- Add Contract Modal -->
    <div id="addContractModal" class="modal hidden" aria-modal="true" role="dialog" aria-labelledby="add-contract-title">
        <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl mx-4 fade-in" role="document">
            <div class="flex justify-between items-center border-b border-gray-200 px-6 py-4">
                ...
                <button id="closeAddContractModal" type="button" class="text-gray-400 hover:text-gray-600 rounded-lg p-2 hover:bg-gray-100 transition-all duration-200" aria-label="Close">
                ...
                <form id="addContractForm" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <button type="button" id="regenerateCode" class="absolute inset-y-0 right-0 px-3 flex items-center text-brand-primary hover:text-brand-primary-hover">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col w-full h-32 border-2 border-dashed border-gray-300 hover:border-gray-400 rounded-lg cursor-pointer hover:bg-gray-50">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3">
                <button type="button" id="cancelAddContract" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                    Cancel
                </button>
                <button type="submit" form="addContractForm" class="px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-brand-primary-hover transition-colors text-sm font-medium">
                    Save Contract
                </button>
            </div>
        </div>
    ...
    <!-- View Contract Modal -->
    <div id="viewContractModal" class="modal hidden" aria-modal="true" role="dialog" aria-labelledby="view-contract-title">
        <div class="bg-white rounded-lg shadow-lg w-[380px] max-w-full mx-4 fade-in" role="document">
            <div class="flex justify-between items-center border-b border-gray-200 px-4 py-3">
                ...
                <button id="closeViewContractModal" type="button" class="text-gray-400 hover:text-gray-600 rounded-lg p-2 hover:bg-gray-100 transition-all duration-200" aria-label="Close">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="px-6 pt-5 pb-6 text-sm text-gray-700 space-y-3">
                <div><span class="font-semibold">Contract ID:</span> <span id="viewContractId" class="text-gray-900"></span></div>
                <div><span class="font-semibold">Title:</span> <span id="viewContractTitle" class="text-gray-900"></span></div>
                <div><span class="font-semibold">Company:</span> <span id="viewContractCompany" class="text-gray-900"></span></div>
                <div><span class="font-semibold">Type:</span> <span id="viewContractType" class="text-gray-900"></span></div>
                <div><span class="font-semibold">Status:</span> <span id="viewContractStatus" class="text-gray-900"></span></div>
                <div><span class="font-semibold">Start Date:</span> <span id="viewContractStartDate" class="text-gray-900"></span></div>
                <div><span class="font-semibold">End Date:</span> <span id="viewContractEndDate" class="text-gray-900"></span></div>
                <div><span class="font-semibold">Created:</span> <span id="viewContractCreated" class="text-gray-900"></span></div>
                <div class="pt-4 flex justify-end">
                    <button id="closeViewContractModal2" type="button" class="px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-brand-primary-hover transition-colors text-sm font-medium">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Edit Contract Modal -->
    <div id="editContractModal" class="modal hidden" aria-modal="true" role="dialog" aria-labelledby="edit-contract-title">
        <div class="bg-white rounded-lg shadow-lg w-[380px] max-w-full mx-4 fade-in" role="document">
            <div class="flex justify-between items-center border-b border-gray-200 px-4 py-3">
                <h3 id="edit-contract-title" class="font-semibold text-sm text-gray-900">Edit Contract</h3>
                <button id="closeEditContractModal" type="button" class="text-gray-400 hover:text-gray-600 rounded-lg p-2 hover:bg-gray-100 transition-all duration-200" aria-label="Close">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="px-6 pt-5 pb-6">
                <form id="editContractForm" class="space-y-3 text-sm text-gray-700">
                    ...
                    <div>
                        <label for="editContractTitle" class="block text-xs font-medium text-gray-700 mb-1">Title</label>
                        <input type="text" id="editContractTitle" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                    </div>
                    <div>
                        <label for="editContractCompany" class="block text-xs font-medium text-gray-700 mb-1">Company</label>
                        <input type="text" id="editContractCompany" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                    </div>
                    <div>
                        <label for="editContractType" class="block text-xs font-medium text-gray-700 mb-1">Type</label>
                        <select id="editContractType" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                            <option value="nda">NDA</option>
                            <option value="service">Service</option>
                            <option value="employment">Employment</option>
                            <option value="employee">Employee</option>
                    ...
                    <div>
                        <label for="editContractStatus" class="block text-xs font-medium text-gray-700 mb-1">Status</label>
                        <select id="editContractStatus" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent" required>
                            <option value="active">Active</option>
                            <option value="pending">Pending</option>
                            <option value="expired">Expired</option>
                        </select>
                    ...
                    <div class="flex justify-end space-x-3 pt-2">
                        <button type="button" id="cancelEditContract" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Cancel</button>
                        <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-brand-primary hover:bg-brand-primary-hover rounded-lg transition-colors">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="deleteContractModal" class="modal hidden" aria-modal="true" role="dialog" aria-labelledby="delete-contract-title">
        <div class="bg-white rounded-lg shadow-lg w-[360px] max-w-full mx-4 fade-in" role="document">
            <div class="flex justify-between items-center border-b border-gray-200 px-4 py-3">
                ...
                <button id="closeDeleteContractModal" type="button" class="text-gray-400 hover:text-gray-600 rounded-lg p-2 hover:bg-gray-100 transition-all duration-200" aria-label="Close">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="px-6 pt-5 pb-6 text-center">
                ...
                <p class="text-sm text-gray-700 mb-3">Are you sure you want to delete <span class="font-semibold" id="deleteContractTitle"></span>?</p>
                <p class="text-xs text-gray-500 mb-4">Contract ID: <span id="deleteContractId" class="font-mono"></span></p>
                <div class="flex justify-center space-x-3">
                    <button type="button" id="cancelDeleteContract" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Cancel</button>
                    <button type="button" id="confirmDeleteContract" class="px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // Contract lock functionality
            function applyContractMasking() {
                ...
                rows.forEach(row => {
                    ...
                    if (isLocked) {
                        ...
                        if (!row.dataset.originalTitle) {
                            row.dataset.originalTitle = titleCell.textContent;
                            row.dataset.originalCompany = companyCell.textContent;
                        }
                        
                        // Apply masking
                        titleCell.innerHTML = '<span class="text-gray-400">******</span> <i class="fas fa-lock text-red-500 text-xs ml-1"></i>';
                        companyCell.textContent = '******';
                    } else {
                        // Restore original data
                        if (row.dataset.originalTitle) {
                            titleCell.textContent = row.dataset.originalTitle;
                            companyCell.textContent = row.dataset.originalCompany;
                        }
                    }
                });
            }

            ...
            <div class="p-6">
                <form id="addContractForm" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="contractTitle" class="block text-sm font-medium text-gray-700 mb-1">Title <span
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="contractType" class="block text-sm font-medium text-gray-700 mb-1">Type <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="contractCompany" class="block text-sm font-medium text-gray-700 mb-1">Company
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label for="startDate" class="block text-sm font-medium text-gray-700 mb-1">Start Date <span
                                    class="text-red-500">*</span></label>
        ...
        <div class="bg-white rounded-lg shadow-lg w-[380px] max-w-full mx-4 fade-in" role="document">
            ...
            <div class="px-6 pt-5 pb-6 text-sm text-gray-700 space-y-3">
                ...
                <div><span class="font-semibold">Company:</span> <span id="viewContractCompany"
                        class="text-gray-900"></span></div>
                <div><span class="font-semibold">Type:</span> <span id="viewContractType" class="text-gray-900"></span>
                </div>
    ...
    <div id="deleteContractModal" class="modal hidden" aria-modal="true" role="dialog"
        ...
        <div class="bg-white rounded-lg shadow-lg w-[360px] max-w-full mx-4 fade-in" role="document">
            ...
            <div class="px-6 pt-5 pb-6 text-center">
                ...
                <p class="text-xs text-gray-500 mb-4">Contract ID: <span id="deleteContractId" class="font-mono"></span>
                </p>

    ...
    <div class="flex justify-between items-center h-full max-w-7xl mx-auto">
      ...
      <div class="flex items-center space-x-2">
        <a href="{{ route('admin.dashboard') }}"
          class="text-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-md">Dashboard</a>
      </div>
    </div>
  </nav>
      ...
      <section class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <button class="text-xs bg-gray-100 hover:bg-gray-200 text-gray-800 px-3 py-1.5 rounded-md"><i
                class="fa-solid fa-chevron-left mr-1"></i>Prev</button>
            <span class="text-sm font-semibold select-none">{{ now()->format('F Y') }}</span>
            <button class="text-xs bg-gray-100 hover:bg-gray-200 text-gray-800 px-3 py-1.5 rounded-md">Next<i
                class="fa-solid fa-chevron-right ml-1"></i></button>
          </div>
        </div>
        <div class="p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <form class="p-6 space-y-4" method="POST" action="#">
            ...
            <div>
              ...
              <input type="text"
                class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#2f855A]"
            ...
            <div class="flex justify-end">
              <button type="submit"
                class="bg-[#28644c] text-white text-sm font-semibold px-4 py-2 rounded-md hover:bg-[#2f855A]">Save</button>
            </div>
          </form>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <ul class="p-4 space-y-3 text-sm">
            <li class="flex items-start gap-3">
              <div
                class="w-8 h-8 rounded-full bg-green-100 text-green-700 flex items-center justify-center text-xs font-bold">
                03</div>
              <div>
            ...
            <li class="flex items-start gap-3">
              <div
                class="w-8 h-8 rounded-full bg-amber-100 text-amber-700 flex items-center justify-center text-xs font-bold">
                22</div>
              <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <div class="p-6 space-y-4 text-sm">
            <div class="flex items-center justify-between">
              ...
              <button
                class="text-xs bg-gray-100 hover:bg-gray-200 text-gray-800 px-3 py-1.5 rounded-md">Connect</button>
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
            ...
            <div class="flex items-center justify-between">
              ...
              <button
                class="text-xs bg-gray-100 hover:bg-gray-200 text-gray-800 px-3 py-1.5 rounded-md">Configure</button>
            </div>
          </div>
        </div>
      </aside>

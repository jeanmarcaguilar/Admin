    ...
    <main class="p-6">
      ...
      <div id="tab-loans" class="tab-content active animate-in delay-3">
        <div class="card">
          ...
          <div id="loans-pagination" class="pagination-container"></div>
        </div>
      </div>
      ...
      <div id="tab-cases" class="tab-content">
        ...
        <div class="card" style="margin-bottom:20px">
          ...
          <div id="cases-pagination" class="pagination-container"></div>
        </div>
        ...
        <div class="card" style="margin-bottom:20px">
          ...
          <div id="demands-pagination" class="pagination-container"></div>
        </div>
      </div>
      ...
      <div id="tab-contracts" class="tab-content">
        ...
        <div id="contract-folder-panel" class="card" style="display:none">
          ...
          <div id="contracts-pagination" class="pagination-container"></div>
        </div>
      </div>
      ...
      <div id="tab-permits" class="tab-content">
        <div class="card">
          ...
          <div id="permits-pagination" class="pagination-container"></div>
        </div>
      </div>
...
// Pagination
Paginator.create('leg-loans', { perPage: 10, onPageChange: function() { renderLoans(); }, alwaysShow: true });
Paginator.create('leg-demands', { perPage: 10, onPageChange: function() { renderDemands(); }, alwaysShow: true });
Paginator.create('leg-cases', { perPage: 10, onPageChange: function() { renderCases(); }, alwaysShow: true });
Paginator.create('leg-contracts', { perPage: 10, onPageChange: function() { renderContracts(); }, alwaysShow: true });
Paginator.create('leg-permits', { perPage: 10, onPageChange: function() { renderPermits(); }, alwaysShow: true });
...
function renderLoans() {
  ...
  if (!loans.length) { 
    tb.innerHTML = emptyRow(9, 'No loan documents found'); 
    Paginator.setTotalItems('leg-loans', 0);
    Paginator.renderControls('leg-loans', 'loans-pagination'); 
    return; 
  }
  var allRows = loans.map(function(l, i) {
    return '<tr>' +
  ...
  var paged = Paginator.paginate('leg-loans', allRows);
  tb.innerHTML = paged.join('');
  Paginator.renderControls('leg-loans', 'loans-pagination');
}
...
function renderDemands() {
  ...
  if (!demands.length) { 
    tb.innerHTML = emptyRow(8, 'No demand letters found'); 
    Paginator.setTotalItems('leg-demands', 0);
    Paginator.renderControls('leg-demands', 'demands-pagination'); 
    return; 
  }
  var allRows = demands.map(function(d, i) {
    return '<tr>' +
  ...
  var paged = Paginator.paginate('leg-demands', allRows);
  tb.innerHTML = paged.join('');
  Paginator.renderControls('leg-demands', 'demands-pagination');
}
...
function renderCases() {
  ...
  if (!filtered.length) { 
    tb.innerHTML = emptyRow(10, 'No legal cases found'); 
    Paginator.setTotalItems('leg-cases', 0);
    Paginator.renderControls('leg-cases', 'cases-pagination'); 
    return; 
  }
  var allRows = filtered.map(function(c) {
  ...
  var paged = Paginator.paginate('leg-cases', allRows);
  tb.innerHTML = paged.join('');
  Paginator.renderControls('leg-cases', 'cases-pagination');
}
...
function renderContracts() {
  ...
  if (!filtered.length) { 
    tb.innerHTML = emptyRow(10, 'No contracts found in this folder'); 
    Paginator.setTotalItems('leg-contracts', 0);
    Paginator.renderControls('leg-contracts', 'contracts-pagination'); 
    return; 
  }
  var allRows = filtered.map(function(c) {
  ...
  var paged = Paginator.paginate('leg-contracts', allRows);
  tb.innerHTML = paged.join('');
  Paginator.renderControls('leg-contracts', 'contracts-pagination');
}
...
function renderPermits() {
  ...
  if (!permits.length) { 
    tb.innerHTML = emptyRow(10, 'No permits found'); 
    Paginator.setTotalItems('leg-permits', 0);
    Paginator.renderControls('leg-permits', 'permits-pagination'); 
    return; 
  }
  var allRows = permits.map(function(p, i) {
  ...
  var paged = Paginator.paginate('leg-permits', allRows);
  tb.innerHTML = paged.join('');
  Paginator.renderControls('leg-permits', 'permits-pagination');
}

...
function renderDocAnalytics() {
  ...
  document.getElementById('da-recent-tbody').innerHTML = recentHtml || '<tr><td colspan="8" class="text-center text-gray-400 py-8">No documents found</td></tr>';
}
...
function renderViewLogs() {
  ...
  tbody.innerHTML = viewLogsData.map(log => {
...
function renderAccessRequests() {
  ...
  tbody.innerHTML = accessRequestsData.map(req => {

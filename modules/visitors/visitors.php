          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <div style="display:flex;gap:8px;align-items:center">
                ...
                <input type="text" id="visitor-search" class="form-input" style="width:200px;padding:6px 12px;font-size:12px" placeholder="🔍 Search visitors..." oninput="Paginator.reset('vis-visitors');renderVisitors()">
            ...
            <div class="card-body">
              ...
              <div id="visitors-pagination"></div>
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <div style="display:flex;gap:8px;align-items:center">
                ...
                <input type="text" id="prereg-sub-search" class="form-input" style="width:180px;padding:6px 12px;font-size:12px" placeholder="🔍 Search pending..." oninput="Paginator.reset('vis-preregs');renderPreregSub()">
      ...
      <div id="tab-logs" class="tab-content">
        ...
        <div class="card">
          ...
          <div style="padding:12px 20px;background:#F9FAFB;border-bottom:1px solid #E5E7EB;display:flex;flex-wrap:wrap;gap:10px;align-items:center">
            ...
            <input type="text" id="log-filter-search" class="form-input" placeholder="Search visitor name..." style="width:180px;padding:6px 12px;font-size:12px" oninput="Paginator.reset('vis-logs');renderLogs()">

            <select id="log-filter-status" class="form-input" style="width:auto;padding:6px 12px;font-size:12px" onchange="Paginator.reset('vis-logs');renderLogs()">
            ...
            <select id="log-filter-purpose" class="form-input" style="width:auto;padding:6px 12px;font-size:12px" onchange="Paginator.reset('vis-logs');renderLogs()">
            ...
            <select id="log-filter-dept" class="form-input" style="width:auto;padding:6px 12px;font-size:12px" onchange="Paginator.reset('vis-logs');renderLogs()">
            ...
            <input type="date" id="log-filter-from" class="form-input" style="width:auto;padding:6px 12px;font-size:12px" onchange="Paginator.reset('vis-logs');renderLogs()" title="From date">

            <input type="date" id="log-filter-to" class="form-input" style="width:auto;padding:6px 12px;font-size:12px" onchange="Paginator.reset('vis-logs');renderLogs()" title="To date">
      ...
      <div id="tab-prereg" class="tab-content">
        ...
        <div class="card" style="margin-bottom:16px">
          ...
          <div class="card-header">
            ...
            <div style="display:flex;gap:8px;align-items:center">
              ...
              <input type="text" id="pr-search" class="form-input" style="width:180px;padding:6px 12px;font-size:12px" placeholder="🔍 Search pending..." oninput="Paginator.reset('vis-prereg-tab');renderPreregTab()">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div id="prereg-tab-pagination"></div>
...
Paginator.create('vis-visitors', { perPage: 10, onPageChange: function() { renderVisitors(); } });

Paginator.create('vis-preregs', { perPage: 10, onPageChange: function() { renderPreregSub(); } });

Paginator.create('vis-logs', { perPage: 10, onPageChange: function() { renderLogs(); } });

Paginator.create('vis-prereg-tab', { perPage: 10, onPageChange: function() { renderPreregTab(); } });
...
// Detect environment: local dev uses /Admin/public/, production uses /verify.php

const QR_PATH = window.location.hostname === 'localhost'

  ? '/Admin/public/verify.php'
...
function qrUrl(code, size) {
  ...
  const verifyPage = QR_DOMAIN + QR_PATH + '?token=' + encodeURIComponent(code);
...
function renderVisitors() {
  ...
  var paged = Paginator.paginate('vis-visitors', allRows);

  tbody.innerHTML = paged.join('');

  Paginator.renderControls('vis-visitors', 'visitors-pagination');
...
function renderPreregSub() {
  ...
  if (!filtered.length) {
    ...
    document.getElementById('preregs-pagination').innerHTML = '';

    return;

  }

  var allRows = filtered.map(p => {
  ...
  var paged = Paginator.paginate('vis-preregs', allRows);

  tbody.innerHTML = paged.join('');

  Paginator.renderControls('vis-preregs', 'preregs-pagination');
...
function renderLogs() {
  ...
  var paged = Paginator.paginate('vis-logs', allRows);

  tbody.innerHTML = paged.join('');

  Paginator.renderControls('vis-logs', 'logs-pagination');
...
function renderPreregTab() {
  ...
  if (!tbody) { document.getElementById('prereg-tab-pagination').innerHTML = ''; return; }

  // Re-read the rows as array for pagination

  var tempDiv = document.createElement('div');

  tempDiv.innerHTML = '<table><tbody>' + tbody + '</tbody></table>';

  var rowEls = tempDiv.querySelectorAll('tr');

  var allRows = [];

  rowEls.forEach(function(r) { allRows.push(r.outerHTML); });

  var paged = Paginator.paginate('vis-prereg-tab', allRows);

  document.getElementById('prereg-tab-tbody').innerHTML = paged.join('');

  Paginator.renderControls('vis-prereg-tab', 'prereg-tab-pagination');
